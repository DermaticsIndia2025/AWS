...
const Chatbot: React.FC<ChatbotProps> = ({ analysisResult, skincareGoals, recommendation, chatHistory, setChatHistory }) => {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-xl border border-slate-200/80 shadow-xl">
      <h3 className="text-2xl font-bold text-slate-900 mb-4 text-center">Ask Your Dermatics AI Assistant</h3>
      <div className="h-[60vh] overflow-y-auto p-4 bg-slate-100 rounded-lg border border-slate-200 mb-4 flex flex-col space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-grow bg-slate-100/80 text-slate-800 placeholder-slate-400 border border-slate-300 rounded-lg py-2.5 px-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-base shadow-sm"
          disabled={isLoading}
        />
