          ...
          {cartItems.length === 0 ? (
            ...
            <>
              <div className="flex-grow overflow-y-auto p-4 space-y-4">
                {cartItems.map(item => (
                  <div key={item.productId} className="flex items-center gap-4 bg-white p-3 rounded-lg border border-slate-200 shadow-sm">
                    <img
                    ...
                    <Button
                      ...
                      className="!p-2 !rounded-full text-slate-400 hover:text-red-500 hover:bg-red-100 self-start"
                    >
