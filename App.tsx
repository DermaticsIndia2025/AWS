  ...
  return (
    <div className="w-full min-h-screen lg:grid lg:grid-cols-[350px,1fr] bg-brand-bg">
      ...
      <div className="w-full h-screen overflow-y-auto flex flex-col">
        ...
        />
        <main className="w-full flex-grow flex items-start justify-center p-4 sm:p-6 md:p-12">
            <div className={`w-full h-full ${step === 4 ? 'max-w-7xl' : 'max-w-6xl'} transition-all duration-300`}>
                {renderStep()}
            </div>
        </main>
      </div>
