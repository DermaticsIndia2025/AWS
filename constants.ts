...
import { AcneIcon, OilDropIcon, TextureIcon, SparklesIcon, ZapIcon, HydrationIcon, AgingIcon, WindIcon, RednessIcon, ShieldCheckIcon, EyeIcon, PigmentationIcon, FolderIcon, HeartIcon, SunIcon } from "./components/Icons";
...
export const LOADING_TIPS: string[] = [
  "Consistency is key! Follow your new routine daily for the best results.",
  "Drink plenty of water throughout the day to keep your skin hydrated from within.",
  "Always remove your makeup before going to bed to prevent clogged pores.",
  "Don't forget to apply sunscreen every morning, even on cloudy days.",
  "A healthy diet rich in antioxidants can significantly improve your skin's health.",
  "Try to get 7-9 hours of quality sleep each night for optimal skin repair.",
  "Avoid touching your face to prevent transferring bacteria and oils.",
  "Change your pillowcases regularly to keep your skin clean while you sleep.",
  "Be patient. It can take several weeks to see the full benefits of a new skincare routine."
];
